...
if [[ "$choose" == "Y" || "$choose" == "y" ]]; then
    ...
    while IFS= read -r domain; do
	shuffledns -d "$domain" -r /home/moza/wordlists/resolvers.txt  -t 10000 -mode bruteforce  -w /home/moza/wordlists/SecLists/Discovery/DNS/bitquark-subdomains-top100000.txt -silent -o subdomains/${domain}-shufflednsresult.txt
    done < "$wildscope_file"
